...
namespace Acme.SimpleTaskApp.Migrations
{
    ...
    [Migration("20191206090851_Customer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Worker.Certificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Worker.HouseWorker", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Acme.SimpleTaskApp.Worker.Certificate", b =>
                {
                    b.HasOne("Acme.SimpleTaskApp.Worker.HouseWorker", "Worker")
                        .WithMany()
